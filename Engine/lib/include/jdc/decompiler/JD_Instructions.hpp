...
namespace jdc
{
    ...
    constexpr const uint8_t OP_nop                 = 0x00;
    constexpr const uint8_t OP_aconst_null         = 0x01;
    constexpr const uint8_t OP_iconst_m1           = 0x02;
    ...
    constexpr const uint8_t OP_lconst_1            = 0x0a;
    ...
    constexpr const uint8_t OP_fcmpl               = 0x95;
    constexpr const uint8_t OP_fcmpg               = 0x96;
    constexpr const uint8_t OP_dcmpl               = 0x97;
    constexpr const uint8_t OP_dcmpg               = 0x98;
    ...
    constexpr const uint8_t OP_breakpoint          = 0xca;

    constexpr const uint8_t OP_RESERVED_impdep_1   = 0xfe; // implementation defined 1
    constexpr const uint8_t OP_RESERVED_impdep_2   = 0xff; // implementation defined 2

    X_GAME_API const char * GetOpName(uint8_t OpCode);
